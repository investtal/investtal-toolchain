...
```sh
gh api "repos/investtal/investtal-toolchain/contents/9cc/install.sh?ref=v0.5.1" --jq '.content' | base64 -d | bash
gh api repos/investtal/investtal-toolchain/contents/9cc/install.sh --jq '.content' | base64 -d | CC9_VERSION=v0.5.1 bash
